...
import io.foshizzle.data.api.deviantart.DeviantartAuthService;
import io.foshizzle.data.api.deviantart.model.AccessToken;
...
import io.foshizzle.util.ScrimUtil;
...
//                Log.d("user", user.toString());
    ...
    private void getAccessToken(String code) {
        ...
        final Call<AccessToken> accessTokenCall =
                deviantartAuthApi.getAccessToken("authorization_code", Integer.valueOf(BuildConfig.DEVIANTART_CLIENT_ID),
                BuildConfig.DEVIANTART_CLIENT_SECRET, BuildConfig.DEVIANTART_REDIRECT_URI,
                code);

        Log.d("getToken", "clientid: "+BuildConfig.DEVIANTART_CLIENT_ID+" secret: "+ BuildConfig.DEVIANTART_CLIENT_SECRET+
                " authCode: "+code+" redirect: "+BuildConfig.DEVIANTART_REDIRECT_URI);
