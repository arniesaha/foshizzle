...
import io.foshizzle.ui.recyclerview.FilterSwipeDismissListener;
...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.FilterViewHolder>
        implements FilterSwipeDismissListener, DribbblePrefs.DribbbleLoginStatusListener, DeviantartPrefs.DeviantartLoginStatusListener {
    ...
    boolean isAuthorisedDeviantartSource(Source source) {
        return source.key.equals(SourceManager.SOURCE_DEVIANTART_POPULAR)
                || source.key.equals(SourceManager.SOURCE_DEVIANTART_DAILY)
                || source.key.equals(SourceManager.SOURCE_DEVIANTART_GALLERY)
                || source.key.equals(SourceManager.SOURCE_DEVIANTART_FEATURED);
    }
