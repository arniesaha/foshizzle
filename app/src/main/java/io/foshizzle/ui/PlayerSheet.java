...
import io.foshizzle.data.PaginatedDataManager;
import io.foshizzle.data.api.deviantart.model.Deviation;
import io.foshizzle.data.api.dribbble.FollowersDataManager;
import io.foshizzle.data.api.dribbble.ShotLikesDataManager;
import io.foshizzle.data.api.dribbble.model.Follow;
import io.foshizzle.data.api.dribbble.model.Like;
import io.foshizzle.data.api.dribbble.model.PlayerListable;
...
import io.foshizzle.ui.widget.BottomSheet;
import io.foshizzle.util.DribbbleUtils;
import io.foshizzle.util.glide.GlideApp;

import static com.bumptech.glide.load.resource.drawable.DrawableTransitionOptions.withCrossFade;
import static io.foshizzle.util.AnimUtils.getLinearOutSlowInInterpolator;
