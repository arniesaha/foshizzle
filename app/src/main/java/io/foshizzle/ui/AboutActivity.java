...
import io.foshizzle.ui.widget.InkPageIndicator;
...
import io.foshizzle.util.glide.GlideRequest;
...
public class AboutActivity extends Activity {
    ...
    static class AboutPagerAdapter extends PagerAdapter {
        ...
        private View aboutFoshizzle;
        @Nullable @BindView(R.id.about_description) TextView foshizzleDescription;
        ...
        private View getPage(int position, ViewGroup parent) {
            switch (position) {
                case 0:
                    if (aboutFoshizzle == null) {
                        aboutFoshizzle = layoutInflater.inflate(R.layout.about_foshizzle, parent, false);
                        ButterKnife.bind(this, aboutFoshizzle);
                        // fun with spans & markdown
                        SpannableString about0 = new SpannableString(markdown.markdownToSpannable
                                (resources.getString(R.string.about_foshizzle_0),
                                        foshizzleDescription, null));
                        about0.setSpan(new AlignmentSpan.Standard(Layout.Alignment.ALIGN_CENTER),
                                0, about0.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

                        SpannableString about1 = new SpannableString(
                                resources.getString(R.string.about_foshizzle_1));
                        ...
                        SpannableString about2 = new SpannableString(markdown.markdownToSpannable
                                (resources.getString(R.string.about_foshizzle_3),
                                        foshizzleDescription, null));
                        ...
                        SpannableString about3 = new SpannableString(markdown.markdownToSpannable
                                (resources.getString(R.string.about_foshizzle_4),
                                        foshizzleDescription, null));
                        ...
                        HtmlUtils.setTextWithNiceLinks(foshizzleDescription, desc);
                    }
                    return aboutFoshizzle;
//                case 1:
//                    if (aboutIcon == null) {
